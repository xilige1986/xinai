...
export async function POST(request: NextRequest) {
  try {
    ...
    const { name, slug: providedSlug, websiteUrl, shortDesc, description, categoryId, subCategoryId, useCaseId, pricingType, imageUrl } = result.data;

    // 使用前端提供的slug或生成slug（URL友好的名称）
